package irfan.bakingapp.data.local.provider;
...
import static irfan.bakingapp.data.local.provider.IngredientContract.CONTENT_AUTHORITY;
import static irfan.bakingapp.data.local.provider.IngredientContract.Entry;
import static irfan.bakingapp.data.local.provider.IngredientContract.Entry.TABLE_NAME;
